...
void		get_game_over_text(t_data *data)
{
	...
	ft_strdel(&sc);
	attron(COLOR_PAIR(2));
	mvprintw(CENTER_J - 6, CENTER_I - (ft_strlen("GAME OVER") / 2),
		"GAME OVER");
	attron(COLOR_PAIR(3));
	mvprintw(CENTER_J - 3, CENTER_I - (ft_strlen("Press 1 to NEW GAME") / 2),
		"Press 1 to NEW GAME");
	mvprintw(CENTER_J, CENTER_I - (ft_strlen("Press 2 to SCORE BOARD") / 2),
		"Press 2 to SCORE BOARD");
	mvprintw(CENTER_J + 3, CENTER_I - (ft_strlen("Press ESC to EXIT") / 2),
		"Press ESC to EXIT");
}
